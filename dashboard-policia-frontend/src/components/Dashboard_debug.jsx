...
const Dashboard = () => {
  ...
  useEffect(() => {
    console.log("Dashboard: Data state after filter application:", data);
    console.log("Dashboard: FilteredData state after filter application:", filteredData);
  }, [filteredData]);
  ...
  const loadInitialData = async () => {
    try {
      ...
      console.log("Dashboard: Data state after initial load:", result);
      console.log("Dashboard: FilteredData state after initial load:", result);
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* KPIs */}
        <KPIPanel data={filteredData || data} />
