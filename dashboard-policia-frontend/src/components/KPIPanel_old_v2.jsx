...
import { Activity, Users, TrendingUp, Heart, Brain, Stethoscope, Child } from 'lucide-react';
...
const KPIPanel = ({ data }) => {
  ...
  const childrenPhysicalActivityPercentage = hasChildrenAndPhysicalActivity 
    ? ((hasChildrenAndPhysicalActivity.count / totalResponses) * 100).toFixed(2) 
    : 0;
  ...
  const topFactors = data.kpis?.top_factors_to_improve || {};
