...
class DataProcessor:
    ...
    def clean_data(self):
        ...
        for col in [
            ...
            if col in self.df.columns:
                self.df[col] = self.df[col].replace({"Si": "Sí", "No ": "No", "A veces ": "A veces"})
    ...
    def get_habits_data(self):
        ...
        df_filtered = self.df.dropna(subset=["¿Realiza algún tipo de actividad física?", " ¿Considera que debe mejorar algunos de estos factores para contribuir a una mejor calidad de vida?"])
    ...
    def get_quality_of_life_data(self):
        ...
        df_filtered = self.df.dropna(subset=["Jerarquía", " ¿Considera que debe mejorar algunos de estos factores para contribuir a una mejor calidad de vida?"])
    ...
    def get_comprehensive_kpis(self):
        ...
        good_physical_health_count = len(self.df[self.df["Salud física actual"] == "Buena"])
        good_mental_health_count = len(self.df[self.df["Salud mental actual"] == "Buena"])
