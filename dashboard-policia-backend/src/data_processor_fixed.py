...
class DataProcessor:
    ...
    def get_demographics_data(self):
        ...
        # Distribución de antigüedad (rangos)
        seniority_dist = self.df['Antigüedad de Servicio'].value_counts().to_dict()
        
        # Promedio de antigüedad (convertir rangos a números)
    ...
    def get_habits_data(self):
        ...
        # ¿Realiza servicios adicionales? (NUEVO)
        additional_services = self.df['¿Realiza servicios adicionales?'].value_counts().to_dict()
        
        # Cantidad de servicios adicionales
        additional_services_count = self.df['Cantidad de adicionales'].value_counts().to_dict()
        
        # Frecuencia de servicios adicionales
        additional_services_frequency = self.df['Frecuencia de adicionales'].value_counts().to_dict()
        ...
        return {
            ...
            'additional_services_count_distribution': additional_services_count,
            'additional_services_frequency_distribution': additional_services_frequency,
    ...
    def get_health_data(self):
        ...
        # Satisfacción con licencias
        license_satisfaction = self.df['¿Se siente satisfecho con la modalidad en la que se le permite el acceso a las licencias anuales o de invierno?'].value_counts().to_dict()
        
        # Descansos durante jornada laboral
        work_breaks = self.df['¿Se habilitan pequeños descansos durante su jornada laboral?'].value_counts().to_dict()
        ...
        return {
            ...
            'license_satisfaction_distribution': license_satisfaction,
            'work_breaks_distribution': work_breaks
        }
    ...
    def get_knowledge_data(self):
        ...
        # Conocimiento de servicios de salud ocupacional (GABINETE)
    ...
    def get_quality_of_life_data(self):
        ...
        # Congruencia riesgo-esfuerzo-remuneración
    ...
    def get_kpis(self):
        ...
        # % que conoce servicios de salud ocupacional (GABINETE)
        ...
        # % que realiza servicios adicionales
